...
function(
    ...
    return declare(NCList, {
        getGlobalStats: function(successCallback, errorCallback) {
            ...
            return (this._deferred.root || this.getDataRoot(name)).then(function(data) { successCallback(data.stats); }, errorCallback);
        },
        ...
        getFeatures: function(query, origFeatCallback, finishCallback, errorCallback) {
            ...
            var shift = function(s) {
                ...
                for (var j = 0; j < projection.length && seq !== projection[j].name; j++) {
